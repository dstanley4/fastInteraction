...
If you specify a path with a filename (e.g., "tables.doc") then the tables below will be created in Word document.
...
![2D graph](https://github.com/dstanley4/fastInteraction/blob/master/vignettes/graph2D.gif)
...
![3D graph](https://github.com/dstanley4/fastInteraction/blob/master/vignettes/graph3D.gif)
